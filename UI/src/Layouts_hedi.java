...
public class Layouts_hedi {
    ...
    public static BorderPane getSearchLayout(){
        ...
        CheckBox t1 = new CheckBox(Utils.TableToString(Main.Table.HOST));
        CheckBox t2 = new CheckBox(Utils.TableToString(Main.Table.REVIEW_COMMENTS));
        CheckBox t3 = new CheckBox(Utils.TableToString(Main.Table.LISTING));
        ...
        searchButton.addEventHandler(MouseEvent.MOUSE_CLICKED, e -> Controllers_hedi.search(txt.getText(), b, tables) );
